<#
.SYNOPSIS
    Compute and other add-ons: selected and available, with prices.
.EXAMPLE
    ./scripts/Get-SBAddons.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Fail-IfError (Get-Api '/api/plugins/supabase/mgmt/addons') | ConvertTo-Json -Depth 6
