<#
.SYNOPSIS
    The names of the edge function secrets (values are never returned).
.EXAMPLE
    ./scripts/Get-SBSecrets.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Out-Json @(Fail-IfError (Get-Api '/api/plugins/supabase/secrets') | Select-Object name, updated_at) 4
