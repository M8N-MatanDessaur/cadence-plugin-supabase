<#
.SYNOPSIS
    Backups: region, point-in-time recovery, WAL archiving, the daily backups kept.
.EXAMPLE
    ./scripts/Get-SBBackups.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Fail-IfError (Get-Api '/api/plugins/supabase/backups') | ConvertTo-Json -Depth 6
