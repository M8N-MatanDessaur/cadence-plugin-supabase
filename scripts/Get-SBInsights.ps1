<#
.SYNOPSIS
    What the advisors flag (security and performance), plus tables without RLS or a primary key, unused indexes, cache hit ratios, bloated tables, long-running statements and the slowest queries.
.EXAMPLE
    ./scripts/Get-SBInsights.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Fail-IfError (Get-Api '/api/plugins/supabase/insights') | ConvertTo-Json -Depth 8
