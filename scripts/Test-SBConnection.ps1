<#
.SYNOPSIS
    Checks the management token and the project keys against Supabase.
.EXAMPLE
    ./scripts/Test-SBConnection.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Get-Api '/api/plugins/supabase/test' | ConvertTo-Json -Depth 4
