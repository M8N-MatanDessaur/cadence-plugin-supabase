<#
.SYNOPSIS
    The services and whether each answers: database, auth, REST, realtime, storage.
.EXAMPLE
    ./scripts/Get-SBHealth.ps1
#>
[CmdletBinding()]
param(
    [string]$Project = ''
...
Fail-IfError (Get-Api '/api/plugins/supabase/mgmt/project/health') | ConvertTo-Json -Depth 6
