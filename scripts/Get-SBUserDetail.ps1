<#
.SYNOPSIS
    One user in full: profile, identities, sessions, MFA factors, metadata.
.EXAMPLE
    ./scripts/Get-SBUserDetail.ps1 -Id <uuid>
#>
[CmdletBinding()]
param(
...
Fail-IfError (Get-Api "/api/plugins/supabase/auth/users/$(Esc $Id)/detail") | ConvertTo-Json -Depth 8
