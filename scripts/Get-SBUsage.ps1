<#
.SYNOPSIS
    Daily usage: database size, egress, storage, API requests over the last days.
.EXAMPLE
    ./scripts/Get-SBUsage.ps1 -Days 14
#>
[CmdletBinding()]
param(
    [int]$Days = 30,
...
Fail-IfError (Get-Api "/api/plugins/supabase/usage/daily?days=$Days") | ConvertTo-Json -Depth 6
