<#
.SYNOPSIS
    Forgets a project on this machine (nothing changes in Supabase).
.EXAMPLE
    ./scripts/Remove-SBProject.ps1 -Name 'my app'
#>
[CmdletBinding()]
param(
...
Fail-IfError (Send-Api 'DELETE' "/api/plugins/supabase/projects/$(Esc $Name)" $null) | Out-Null
[pscustomobject]@{ ok = $true; forgotten = $Name } | ConvertTo-Json
