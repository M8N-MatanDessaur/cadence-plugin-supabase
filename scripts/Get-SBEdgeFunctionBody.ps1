<#
.SYNOPSIS
    The source of an edge function. -OutFile writes it to a file.
.EXAMPLE
    ./scripts/Get-SBEdgeFunctionBody.ps1 -Slug hello -OutFile .ai-workspace/hello.ts
#>
[CmdletBinding()]
param(
...
$text = Get-Text "/api/plugins/supabase/edge/functions/$(Esc $Slug)/body"
